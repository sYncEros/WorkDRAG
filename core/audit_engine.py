...
class AuditEngine:
    ...
    def run_all_skills(self, skills: list = None):
        ...
        from skills.remote_access_audit.remote_access_audit import RemoteAccessAudit
        from skills.network_capture_audit.network_capture_audit import NetworkCaptureAudit
        from skills.scheduled_tasks_deep_audit.scheduled_tasks_deep_audit import ScheduledTasksDeepAudit
        from skills.dns_network_forensics.dns_network_forensics import DNSNetworkForensics
        from skills.filesystem_timeline.filesystem_timeline import FilesystemTimeline
        ...
        available = {
            ...
            "remote_access":         RemoteAccessAudit,
            "network_capture":       NetworkCaptureAudit,
            "scheduled_tasks_deep":  ScheduledTasksDeepAudit,
            "dns_network_forensics": DNSNetworkForensics,
            "filesystem_timeline":   FilesystemTimeline,
        }
