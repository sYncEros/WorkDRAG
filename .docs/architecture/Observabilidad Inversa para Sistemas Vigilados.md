# Observabilidad Inversa para Sistemas Vigilados
...
PowerShell# Medir carga externa vs productividadGet-Process | Sort-Object CPU -Descending | Select-Object -First 10Mostrar más líneas
