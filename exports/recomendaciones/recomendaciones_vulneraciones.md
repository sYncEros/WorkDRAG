...
## 1. Acceso remoto habilitado al equipo del trabajador

- Categoría: `identity_remote_access`
- Riesgo legal: **HIGH**

### Motivo

RDP habilitado permite acceso completo al escritorio sin que el trabajador lo sepa. Una conexión activa sin notificación puede constituir vigilancia encubierta y vulnerar CP art. 197.
...
## 2. Add-ins de Outlook con acceso al buzón corporativo

- Categoría: `email_outlook_addins`
- Riesgo legal: **HIGH**

### Motivo

Los add-ins de Outlook tienen acceso completo a emails, contactos y calendarios. Los add-ins corporativos forzados pueden enviar copias de emails a sistemas de supervisión. Requieren información previa bajo LOPDGDD art. 87.

### Recomendaciones

- Solicitar al empleador listado de add-ins forzados y su función.
- Verificar si los add-ins envían datos a sistemas de archivado.
- Consultar con el DPO qué datos de email se tratan.
...
- Categoría: `cloud_sync_folder_redirect`
- Riesgo legal: **HIGH**
...
## 5. Logging centralizado de actividad del equipo activo (WEF, PS Transcription)

- Categoría: `behavior_logging_capabilities`
- Riesgo legal: **HIGH**

### Motivo

Windows Event Forwarding y PowerShell Transcription permiten centralizar en tiempo real toda la actividad del equipo. El análisis de este volumen de datos puede constituir un perfilado del trabajador que requiere DPIA bajo RGPD art. 35.
...
- Exigir que se informe sobre el uso de los datos recopilados.
...
- [LOPDGDD Art. 87 — Derecho a la intimidad en el trabajo](https://www.boe.es/buscar/act.php?id=BOE-A-2018-16673)
- [RGPD Art. 5 — Principios del tratamiento](https://eur-lex.europa.eu/legal-content/ES/TXT/?uri=CELEX:32016R0679)
- [RGPD Art. 35 — Evaluación de impacto (DPIA)](https://eur-lex.europa.eu/legal-content/ES/TXT/?uri=CELEX:32016R0679)

## 6. Servicio DiagTrack — telemetría continua activa

- Categoría: `telemetry_services`
- Riesgo legal: **HIGH**

### Motivo

DiagTrack recopila y envía datos de actividad continuamente. En equipos corporativos el empleador es corresponsable del tratamiento bajo RGPD art. 26. No haberlo desactivado por política es una omisión relevante.
...
## 7. Telemetría completa de Windows activa

- Categoría: `telemetry_windows_level`
- Riesgo legal: **HIGH**

### Motivo

Windows en nivel de telemetría completo envía datos de actividad, contenido de documentos y uso de aplicaciones a Microsoft en EEUU. Transferencia internacional sin control explícito del trabajador. El empleador como responsable del tratamiento debe garantizar una base legal adecuada bajo RGPD cap. V.
...
- Exigir registro de actividades de tratamiento que incluya esta transferencia.
...
## 8. Acceso al portapapeles del trabajador

- Categoría: `privacy_clipboard`
- Riesgo legal: **MEDIUM-HIGH**

### Motivo

El portapapeles puede contener contraseñas, tokens y datos bancarios. Su acceso por software corporativo sin consentimiento puede capturar datos especialmente sensibles bajo RGPD art. 9.
